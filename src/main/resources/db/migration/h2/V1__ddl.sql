...
CREATE
MEMORY
TABLE "ORDER_ENTITY_ORDER_LINE_ITEMS"
(
...
ALTER TABLE "ORDER_ENTITY_ORDER_LINE_ITEMS"
    ADD CONSTRAINT "FKGAJ6H7W5XQBRDP8NY5QWV27I9" FOREIGN KEY ("ORDER_ENTITY_ID") REFERENCES "ORDER_ENTITY" ("ID") NOCHECK;
